...
def mine_block():
	...
	blockchain.add_transaction(sender = node_address, reciever = 'Deepak', amount = 1)
...
def connect_node():
	...
	response = {'message': 'All the nodes are now connected. The Softcoin Blockchain now contains the following nodes:',
